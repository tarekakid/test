...
@endphp
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <form runat="server" method="POST" action="{{ url('search-material') }}"
                    ...
                    @endphp
                        <tr>
                            ...
                            <td class="text-nowrap text-end">
                                ...
                                <a href="{{ url('delete-material/'. $material->id) }}" class="text-decoration-none" onclick="return confirm('Are you sure?')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
